...
This wrapper supplies Product/Quotient's typed compiler to the shared pending
review builder. Packet generation validates but never changes review state and
never emits a release artifact.
"""
...
def build_pending_product_quotient_packet(
    ...
    """Compile exact pending Product/Quotient inputs for human review."""
